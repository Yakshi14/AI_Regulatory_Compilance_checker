...
## 🚀 Key Features
- **RAG Architecture:** Live retrieval from a 500+ page legal dataset.
- **Async Processing:** Built with `asyncio` for non-blocking API calls.
- **Quantized Embeddings:** Optimized vector storage for lower memory footprint.
